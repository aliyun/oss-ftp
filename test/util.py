...
class myThread(threading.Thread):
    def __init__(self, thread_id, masquerade_address="", listen_address="127.0.0.1", port=2048,
                 log_level="DEBUG", bucket_endpoints="", internal=None, passive_ports_start=51000, passive_ports_end=52000, buff_size=10, protocol='https'):
        ...
        self.passive_ports = range(passive_ports_start, passive_ports_end)
